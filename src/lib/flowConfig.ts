...
export const FLOWS: Record<LeadType, Question[]> = {
  buyer: [
    ...
    { id: 'buyer_bedrooms', text: 'How many bedrooms do you need?', type: 'select', dynamicOptions: getDynamicBedrooms('buyer_property_type'ntly in Dubai?', type: 'select', options: [{ label: 'Yes', value: 'Yes' }, { label: 'No', value: 'No' }] },
  ],
 ...
 , text: 'Is your property readselect', options: [{ label: 'R { label: 'Off-Plan', value: ': 'seller_payment_status', texstatus?', type: 'select', options: [{ label: 'Fully Paid', value: 'Fully Paid' }, { label: 'Mortgage', value: 'Mortgage' }, { label: 'Payment Plan', value: 'Payment Plan' }], condition: a => a.seller_status === 'Ready' },
  ...
  tenant: [
    ...
    { id: 'tenant_timeline', teed to move in?', type: 'select', options: TIMELINE },cheques', text: 'Preferred payment method?', type: 'se     { label: '1 Cheque', value: '1 Cheque' },
      {, value: '2 Cheques' },
  ...
  landlord: [
    ...
    { id: 'landlord_status', text: 'Is youan?', type: 'select', options: [{ label: 'Ready', value: 'Ready' }, { labf-Plan' }] },
    { id: 'landlord_offplan_payment', text: 'What is the paect', options: [{ label: 'Fully Paid', value: 'Fully Paid' }, { label: 'Payment Plan', value: 'Payment Plan' }], condition: a => a.landlord_status === 'Off-Plan' },
  ...
  offplan: [
    ...
    { id: 'offplan_style', text: 'What is your investment st      { label: 'Low Down Payment', value: 'Low DP' },
      { label: '1% Monthly Plan', value: '1% p', value: 'Flip' },
  ...
  luxury: [
    ...
    { id: 'luxury_dp_ready', text: 'Is your down payment ready?', type: 'select', condition:, options: [{ label: 'Yes', value: 'Yes' }, { label: 'No', value: 'No' }] },
